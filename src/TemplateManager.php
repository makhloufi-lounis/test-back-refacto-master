...
class TemplateManager
{
    ...
    public function getTemplateComputed(Template $tpl, array $data)
    {
        ...
        if($quote) {
            $site = (!empty($quote->getSiteId()) && !is_null($quote->getSiteId()))
                ? SiteRepository::getInstance()->getById($quote->getSiteId())
                : $this->applicationContext->getCurrentSite() ;
            $destination = (!empty($quote->getSiteId()) && !is_null($quote->getSiteId()))
                ? DestinationRepository::getInstance()->getById($quote->getDestinationId())
                : null;
